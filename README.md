...
### 5-adding-root-component

for better testing and avoid component hierarchy, we will take out provider and redux logic out of index.js

Root.js - Higherorder component
...
### 7-redux-initial-state

we will create initial state object using createStore function inside the root.js
